 ...
 * TodayHandlerTest
 */
class TodayHandlerTest extends HandlerTest
{
    /**
     * @var \today_handler $handler
     */
    protected $handler;
    ...
    public function parseModxDotToday()
    {
        ...
        $this->assertEquals('2020-05-09', $actual['regrinfo']['domain']['changed']);
        $this->assertEquals('2014-05-09', $actual['regrinfo']['domain']['created']);
        $this->assertEquals('2021-05-09', $actual['regrinfo']['domain']['expires']);
