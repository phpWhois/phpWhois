 ...
 * DevHandlerTest
 */
class DevHandlerTest extends HandlerTest
{
    /**
     * @var \dev_handler $handler
     */
    protected $handler;
    ...
    public function parseOstapDotDev()
    {
        ...
        $this->assertEquals('2020-02-26', $actual['regrinfo']['domain']['changed']);
        $this->assertEquals('2019-02-28', $actual['regrinfo']['domain']['created']);
        $this->assertEquals('2021-02-28', $actual['regrinfo']['domain']['expires']);
