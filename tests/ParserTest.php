...
class ParserTest extends BaseTestCase
{
     ...
     */
    public function get_date(string $date, string $format, string $expected): void
    {
     ...
     * @group CVE-2015-5243
     */
    public function generic_parser_a_blocks(): void
    {
        $translate  = [
     ...
     * @group CVE-2015-5243
     */
    public function generic_parser_b(): void
    {
     ...
     * @group CVE-2015-5243
     */
    public function get_blocks_one(): void
    {
        $items   = [
            'domain.name' => 'Domain:',
        ];
     ...
     * @group CVE-2015-5243
     */
    public function get_blocks_two(): void
    {
        $items   = [
            'agent' => 'Registrar:',
        ];
     ...
     * @group CVE-2015-5243
     */
    public function get_contact(): void
    {
